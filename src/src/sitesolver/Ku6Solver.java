...
public class Ku6Solver extends SiteSolver {
	...
	{
		//检验是否为酷6网URL
		if (!m_url.toString().toLowerCase().contains("ku6"))
			return;
		...
		{
			//debug
			System.out.println("Ku6Solve end work, with input URL a file URL.");
	...
	public boolean analyzeFileUrl(URL fileUrl)
	{
		...
		Vector<URL> sub1Urls = super.getMatchedUrls(contentBuffer,
				"http://www.flvcd.com/parse.php?kw=","http://v.ku6.com/\\S+.html","");
